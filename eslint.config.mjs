...
export default defineConfig([
  ...
  
  {
    ...
    rules: {
      ...
      // onLongPress (e.g. opening a link bookmark's URL in the browser). Always pass an
      // explicit duration, e.g. .longPress(timeouts.TWO_SEC). The selector matches only
      // zero-arg calls, so .longPress(timeouts.X) / .longPress(2000) are unaffected, and
      // Gesture.LongPress (capital L, react-native-gesture-handler) is excluded too.
      "no-restricted-syntax": [
        "error",
        {
