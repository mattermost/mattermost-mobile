...
describe('Classification Banner - Offline / Cache Behaviour', () => {
    ...
    it('MM-T6206 - should display the banner from DB cache when API is unreachable on reload', async () => {
    ...
    it('MM-T6207 - should show stale cached value when API is blocked after a server change', async () => {
    ...
    it('MM-T6208 - should not display the banner when there is no cached data and the API is blocked', async () => {
