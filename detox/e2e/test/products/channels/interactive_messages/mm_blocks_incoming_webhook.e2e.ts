...
describe.skip('Interactive mm_blocks (incoming webhook)', () => {
    ...
    it('MM-T6214_1 - should render native mm_blocks payload from an incoming webhook', async () => {
    ...
    it('MM-T6215_1 - should show disabled mm_blocks button without firing integration', async () => {
    ...
    it('MM-T6216_1 - should omit malformed mm_blocks and render valid entries', async () => {
    ...
    it('MM-T6228_1 - should toggle collapsible mm_blocks open and closed', async () => {
    ...
    it('MM-T6229_1 - should start expanded when collapsible collapsed is false', async () => {
