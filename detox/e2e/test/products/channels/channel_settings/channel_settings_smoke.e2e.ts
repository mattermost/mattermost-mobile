...
describe('Channel Settings - Smoke', () => {
    ...
    // Unskipped (SEC-10993): duplicate navigation.header.back resolved via the
    // shared NavigationHeader.tapBackButton helper (ThreadScreen.back + ChannelScreen.back).
