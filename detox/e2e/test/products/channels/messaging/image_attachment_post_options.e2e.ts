...
describe('Messaging - Image Attachment Post Options', () => {
    ...
    // SEC-11015: safest BACK_INDEX unskip — ThreadScreen.back uses tapTopmostBackButton;
    // post is API-created (no UI-send flake); failure comment was BACK_INDEX only.
