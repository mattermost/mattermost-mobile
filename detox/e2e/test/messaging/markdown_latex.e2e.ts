...
describe('Messaging - Markdown Latex', () => {
    ...
    it('should be able to display markdown latex code block', async () => {
        // # Open a channel screen and post a latex code block
    ...
    it('should be able to display markdown inline latex -- KNOWN ISSUE: MM-45466', async () => {
        // # Open a channel screen and post a inline latex
        // eslint-disable-next-line no-useless-escape
        const message = 'X_k = \sum_{n=0}^{2N-1} x_n \cos \left[\frac{\pi}{N} \left(n+\frac{1}{2}+\frac{N}{2}\right) \left(k+\frac{1}{2}\right) \right]';
