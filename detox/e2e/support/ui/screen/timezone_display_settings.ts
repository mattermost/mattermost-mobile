...
class TimezoneDisplaySettingsScreen {
    testID = {
        ...
        automaticOptionToggledOff: 'timezone_display_settings.automatic.option.toggled.false.undefined',
        automaticOptionToggledOn: 'timezone_display_settings.automatic.option.toggled.true.undefined',
