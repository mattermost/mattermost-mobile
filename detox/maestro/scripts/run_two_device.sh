...
# Usage: DEVICE_A_UDID=<udid> DEVICE_B_UDID=<udid> ./detox/maestro/scripts/run_two_device.sh
...
~/.maestro/bin/maestro \
  ...
  detox/maestro/flows/multi_device/user_a_sends_message.yml \
...
POLL_COUNT=0
MAX_POLLS=30
until npx tsx detox/maestro/fixtures/poll_for_message.ts; do
...
~/.maestro/bin/maestro \
  ...
  detox/maestro/flows/multi_device/user_b_receives_message.yml \
