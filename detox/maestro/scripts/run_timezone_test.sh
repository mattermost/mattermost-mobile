...
# Usage: ./detox/maestro/scripts/run_timezone_test.sh [--android ADB_SERIAL | --ios SIMULATOR_UDID] [TIMEZONE]
# Examples:
#   iOS:     ./detox/maestro/scripts/run_timezone_test.sh --ios 6F3708EC-xxxx America/New_York
#   Android: ./detox/maestro/scripts/run_timezone_test.sh --android emulator-5554 America/New_York
