...
|------|------------|---------------------|
| PR E2E | `e2e-test/detox-check`, `e2e-test/maestro-check`, `e2e-test/ios-build` or `ios-build-cache`, `e2e-test/android-build` or `android-build-cache`, `e2e-test/android-maestro-build` or `android-maestro-build-cache`, `e2e-test/test-servers-created/{ios,android,ipad,maestro-ios,maestro-android}`, `e2e-test/test-servers-destroyed/{ios,android,ipad,maestro-ios,maestro-android}`, `e2e-test/detox-ios`, `e2e-test/detox-android`, `e2e-test/detox-ipad`, `e2e-test/maestro-ios`, `e2e-test/maestro-android` | `mobile-pr-<job>` (e.g. `mobile-pr-detox-ios`) |
