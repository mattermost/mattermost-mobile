...
|------|------------|---------------------|
| PR E2E | `e2e-test/detox-check`, `e2e-test/maestro-check`, `e2e-test/ios-build` or `ios-build-cache`, `e2e-test/android-build` or `android-build-cache`, `e2e-test/test-servers-created`, `e2e-test/test-servers-destroyed`, `e2e-test/detox-ios` (then android, ipad, maestro) | `mobile-pr-<job>` (e.g. `mobile-pr-detox-ios`) |
