...
Key terminology for AI-assisted translation: mobile-specific additions to the core Mattermost glossary (see the mattermost repo i18n/glossary for core terms).
