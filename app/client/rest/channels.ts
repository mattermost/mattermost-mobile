...
export interface ClientChannelsMix {
    ...
    getMyChannelMember: (channelId: string) => Promise<MyChannelMembership>;
    getMyChannelMembers: (teamId: string) => Promise<MyChannelMembership[]>;
    getChannelMembers: (channelId: string, page?: number, perPage?: number) => Promise<MyChannelMembership[]>;
    getChannelTimezones: (channelId: string) => Promise<string[]>;
    getChannelMember: (channelId: string, userId: string) => Promise<MyChannelMembership>;
    getChannelMembersByIds: (channelId: string, userIds: string[]) => Promise<MyChannelMembership[]>;
    addToChannel: (userId: string, channelId: string, postRootId?: string) => Promise<MyChannelMembership>;
