...
export type GQLQuery = {
    ...
    teamMembers: Partial<GQLTeamMembership>[],
    channels?: Partial<GQLChannel>[],
    channelsLeft?: Partial<GQLChannel>[],
    channelMembers?: Partial<GQLChannelMembership>[],
}
...
export type GQLUser = {
	...
	position: string,
	roles: Partial<GQLRole>[],
	preferences: Partial<GQLPreference>[],
}
...
export type GQLTeamMembership = {
	...
	schemeUser: boolean,
	schemeAdmin: boolean,
	sidebarCategories: Partial<GQLSidebarCategory>[],
}
