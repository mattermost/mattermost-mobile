...
export const ssoLogin = async (serverUrl: string, serverDisplayName: string, serverIdentifier: string, bearerToken: string, csrfToken: string, sharedPassword?: string): Promise<LoginActionResponse> => {
    ...
    try {
        ...
        client.setClientCredentials(bearerToken, sharedPassword);
        client.setCSRFToken(csrfToken);
