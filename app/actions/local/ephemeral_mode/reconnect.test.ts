...
describe('reconnectErasedServer', () => {
    ...
    it('on success: runs upgradeEntry, clears persistenceFlag, and navigates home', async () => {
    ...
    it('on 401: clears persistenceFlag and credentials, then relaunches into AddServer', async () => {
