...
// groups: MM-41882 export const isRecordGroupMembershipEqualToRaw = (record: GroupMembershipModel, raw: GroupMembership) => {
// groups: MM-41882     return raw.user_id === record.userId && raw.group_id === record.groupId;
// groups: MM-41882 };
...
// groups: MM-41882 export const isRecordGroupEqualToRaw = (record: GroupModel, raw: Group) => {
// groups: MM-41882     return raw.id === record.id;
// groups: MM-41882 };
// groups: MM-41882
// groups: MM-41882 export const isRecordGroupsTeamEqualToRaw = (record: GroupsTeamModel, raw: GroupTeam) => {
// groups: MM-41882     return raw.team_id === record.teamId && raw.group_id === record.groupId;
// groups: MM-41882 };
// groups: MM-41882
// groups: MM-41882 export const isRecordGroupsChannelEqualToRaw = (record: GroupsChannelModel, raw: GroupChannel) => {
// groups: MM-41882     return raw.channel_id === record.channelId && raw.group_id === record.groupId;
// groups: MM-41882 };
