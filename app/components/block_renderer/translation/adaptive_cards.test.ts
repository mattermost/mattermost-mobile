...
describe('translateAdaptiveCards Input.Toggle', () => {
    ...
    it('should use title as the required label when Adaptive Cards label is omitted', () => {
        expect(translateAdaptiveCards([{
            type: 'AdaptiveCard',
            body: [{
                type: 'Input.Toggle',
    ...
    it('should reject Input.Toggle without label or title', () => {
        expect(translateAdaptiveCards([{
            type: 'AdaptiveCard',
            body: [{
                type: 'Input.Toggle',
...
describe('translateAdaptiveCards Input.ChoiceSet', () => {
    ...
    it('should reject ChoiceSet without usable choices and keep single-select values scalar', () => {
        expect(translateAdaptiveCards([{
            type: 'AdaptiveCard',
            body: [{
                type: 'Input.ChoiceSet',
