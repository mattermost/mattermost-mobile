...
describe('MmBlocksImage', () => {
    ...
    beforeEach(() => {
        ...
        jest.mocked(ExpoImage).mockImplementation(({
            ...
            return React.createElement(Text, {testID: 'expo-image', style, id, nativeID}, uri);
        });
    ...
    it('should update the cache id when imageUrl changes on re-render', () => {
        ...
        expect(getByTestId('expo-image')).toHaveProp('nativeID', `MmBlocksImage-${firstId}`);
        ...
        expect(getByTestId('expo-image')).toHaveProp('nativeID', `MmBlocksImage-${secondId}`);
