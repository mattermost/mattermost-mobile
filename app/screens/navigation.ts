...
import {Appearance, DeviceEventEmitter, Platform, Alert, type EmitterSubscription} from 'react-native';
...
export function getThemeFromState(): Theme {
    return EphemeralStore.getTheme() || getDefaultThemeByAppearance();
}
