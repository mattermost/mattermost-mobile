...
import {dismissBottomSheet, updateParams} from '@utils/navigation/adapter';
...
const ServerItem = ({
    ...
    const switchAndLogin = useCallback(async () => {
    ...
    }, [server.url, server.displayName, intl, theme]);
    ...
    const onServerPressed = useCallback(async () => {
        ...
        switchAndLogin();
    }, [isActive, server.lastActiveAt, server.url, switchAndLogin]);
