...
const MmBlocksComponentLibrary = () => {
    ...
    return (
        <View style={{padding: 8}}>
            ...
            {!parsed.ok && (
                <Text
                    style={{color: theme.errorTextColor, marginVertical: 8, ...typography('Body', 100)}}
            ...
            {emptyTranslation && (
                <Text
                    style={{color: changeOpacity(theme.centerChannelColor, 0.64), marginVertical: 8, ...typography('Body', 100)}}
                >
