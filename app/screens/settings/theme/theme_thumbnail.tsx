...
function ThemeThumbnail({
    ...
    return (
        <Svg width={width} height={height} viewBox={`0 0 ${baseWidth} ${baseHeight}`} fill='none' style={[styles.border]}>
            <Rect fill={centerChannelBg} x='0' y='0' width={baseWidth} height={baseHeight}/>
            <Rect fill={centerChannelBg} x={sidebarWidth} y={0} width={postsContainerWidth} height={baseHeight}/>
            <Rect fill={newMessageSeparator} x={sidebarWidth} y={spacing * 4 + rowHeight * 3} width={postsContainerWidth} height='1'/>
            <Rect fill={buttonBg} x={sidebarWidth + spacing * 4} y={spacing * 8 + rowHeight * 6 + 1} width={buttonWidth} height={rowHeight} rx={rowRadius}/>
            <Rect fill={centerChannelColor} x={sidebarWidth + spacing} y={spacing * 9 + rowHeight * 7 + 1} width={postWidth} height={postInputHeight} rx={postInputHeight / 2}/>
            <Rect fill={centerChannelBg} x={sidebarWidth + spacing + 1} y={spacing * 9 + rowHeight * 7 + 2} width={postWidth - 2} height={postInputHeight - 2} rx={(postInputHeight - 2) / 2}/>
            ...
            <G>
                <Rect fill={sidebarBg} x={0} y={0} width={sidebarWidth} height={baseHeight}/>
                <G fill={sidebarText}>
                ...
                <Circle fill={onlineIndicator} cx={spacing + rowRadius} cy={spacing * 3 + rowHeight * 2 + rowRadius} r={rowRadius}/>
                <Circle fill={awayIndicator} cx={spacing + rowRadius} cy={spacing * 6 + rowHeight * 5 + rowRadius} r={rowRadius}/>
                <Circle fill={dndIndicator} cx={spacing + rowRadius} cy={spacing * 9 + rowHeight * 8 + rowRadius} r={rowRadius}/>
