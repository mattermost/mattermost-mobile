...
// REPRO ONLY — do not commit. Verifies whether withObservables-driven UI
// catches up after react-freeze suspension (freezeOnBlur on home tabs),
// the suspected root cause of the saved/pinned/recent-mentions e2e family:
// frozen tabs render mount-time data and never reflect later DB changes.
