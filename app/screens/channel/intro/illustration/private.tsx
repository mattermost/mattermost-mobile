...
const PrivateChannelIllustration = ({theme}: Props) => (
    ...
    >
        <G clipPath='url(#a)'>
            ...
            />
            <Path
                d='M30.092 50.07H5.554a5.44 5.44 0 0 1-3.845-1.575A5.417 5.417 0 0 1 .106 44.67V29.69S1.82 43.542 2.127 44.761c.308 1.22.919 3.044 3.813 3.347 2.894.302 24.152 1.962 24.152 1.962Z'
                fill='#000'
                fillOpacity={0.16}
            />
            <Path
            ...
            />
            <Path
                d='M45.856 24.928a10.99 10.99 0 0 0-5.26-6.628.38.38 0 0 1 .157-.72c2.453-.147 7.404.376 5.852 7.311a.385.385 0 0 1-.75.037Z'
                fill='#fff'
                fillOpacity={0.16}
            />
            <Path
            ...
            />
            <Path
                d='M205.125 85.23a15.668 15.668 0 0 0-2.84-5.491 15.87 15.87 0 0 0-4.756-3.991.545.545 0 0 1-.29-.601.545.545 0 0 1 .515-.428c3.543-.21 10.695.537 8.453 10.458a.553.553 0 0 1-.52.446.563.563 0 0 1-.562-.393Z'
                fill='#FFD470'
            />
        </G>
        <Defs>
