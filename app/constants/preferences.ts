...
const Preferences = {
    ...
    THEMES: {
        ...
        daakia: {
            ...
            sidebarText: '#ffffff',
            sidebarUnreadText: '#ffffff',
            sidebarTextHoverBg: '#2a3a4a',
            sidebarTextActiveBorder: '#0a84ff',
            sidebarTextActiveColor: '#ffffff',
            sidebarHeaderBg: '#15202b',
            sidebarHeaderTextColor: '#ffffff',
            sidebarTeamBarBg: '#15202b',
            onlineIndicator: '#4caf50',
            awayIndicator: '#ff9800',
            dndIndicator: '#f44336',
            mentionBg: '#0a84ff',
            mentionColor: '#ffffff',
            centerChannelBg: '#15202b',
            centerChannelColor: '#ffffff',
            newMessageSeparator: '#3da3ff',
            linkColor: '#0a84ff',
            buttonBg: '#0a84ff',
            buttonColor: '#ffffff',
            errorTextColor: '#f44336',
            mentionHighlightBg: '#1a3a5a',
            mentionHighlightLink: '#3da3ff',
            codeTheme: 'monokai',
        },
