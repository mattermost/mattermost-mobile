...
export const LARGE_HEADER_PROGRESSVIEW_OFFSET = Platform.select({
    android: LARGE_HEADER_TITLE + ANDROID_DEFAULT_HEADER_HEIGHT + HEADER_WITH_SUBTITLE,
    ios: LARGE_HEADER_TITLE + IOS_DEFAULT_HEADER_HEIGHT + HEADER_WITH_SUBTITLE,
});
