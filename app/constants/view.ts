...
export const CLASSIFICATION_BANNER_HEIGHT = 20;
export const CLASSIFICATION_BANNER_MARGIN_BOTTOM = 5;
export const CLASSIFICATION_BANNER_MARGIN_HORIZONTAL = 8;
export const CLASSIFICATION_BANNER_TOTAL_HEIGHT = CLASSIFICATION_BANNER_HEIGHT + CLASSIFICATION_BANNER_MARGIN_BOTTOM;
export const CLASSIFICATION_BANNER_RADIUS = 4;
