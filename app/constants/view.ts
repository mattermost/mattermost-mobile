...
// Floating Banner Constants
export const FLOATING_BANNER_BOTTOM_OFFSET_PHONE_IOS = 105;
export const FLOATING_BANNER_BOTTOM_OFFSET_PHONE_ANDROID = 90;
export const FLOATING_BANNER_BOTTOM_OFFSET_WITH_KEYBOARD_IOS = 70;
export const FLOATING_BANNER_BOTTOM_OFFSET_WITH_KEYBOARD_ANDROID = 80;
export const FLOATING_BANNER_TABLET_EXTRA_BOTTOM_OFFSET = 60;
