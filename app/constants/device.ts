...
/**
 * Checks if the current platform is Android with edge-to-edge display (API 30+).
 * Android 30+ uses edge-to-edge layout where content extends behind system bars,
...
export default {
    ...
    PUSH_NOTIFY_APPLE_VOIP_REACT_NATIVE: 'apple_voip_rn',
};
