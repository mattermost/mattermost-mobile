...
describe('Actions.Posts', () => {
    ...
    it('getPostThread', async () => {
        ...
        nock(Client4.getBaseRoute()).
            get(`/posts/${post.id}/thread?collapsedThreads=false&collapsedThreadsExtended=false`).
            reply(200, postList);
    ...
    it('pinPost', async () => {
        ...
        nock(Client4.getBaseRoute()).
            get(`/posts/${post1.id}/thread?collapsedThreads=false&collapsedThreadsExtended=false`).
            reply(200, postList);
