...
/**
 * Returns a query for all AI bots in the database, default bot first (the
 * server returns the default first from /ai_bots; sorting preserves that
 * ordering across caching), then alphabetical for determinism.
 */
