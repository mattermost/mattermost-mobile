...
export interface DeepLinkCallsIncoming {
    serverUrl: string;
    channelId: string;
}
...
export interface DeepLinkWithData {
    type: DeepLinkType;
    url: string;
    data?: DeepLinkChannel | DeepLinkDM | DeepLinkGM | DeepLinkPermalink | DeepLinkPlugin | DeepLinkServer | DeepLinkPlaybooks | DeepLinkPlaybookRuns | DeepLinkMagicLink | DeepLinkCallsIncoming;
}
