...
#   ~/.maestro/bin/maestro test maestro/flows/calls/start_call.yml
#
...
#      -- writes credentials to maestro/.maestro-test-env.sh
#
# After this completes, `source maestro/.maestro-test-env.sh` sets:
