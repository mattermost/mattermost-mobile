...
module.exports = [
    ...
    'app/redux/action_types/bots.ts',
    'app/redux/action_types/channels.ts',
    'app/redux/action_types/emojis.ts',
    'app/redux/action_types/errors.ts',
    'app/redux/action_types/files.ts',
    'app/redux/action_types/general.ts',
    'app/redux/action_types/gifs.ts',
    'app/redux/action_types/groups.ts',
    'app/redux/action_types/index.ts',
    'app/redux/action_types/integrations.ts',
    'app/redux/action_types/jobs.ts',
    'app/redux/action_types/plugins.ts',
    'app/redux/action_types/posts.ts',
    'app/redux/action_types/preferences.ts',
    'app/redux/action_types/roles.ts',
    'app/redux/action_types/schemes.ts',
    'app/redux/action_types/search.ts',
    'app/redux/action_types/teams.ts',
    'app/redux/action_types/users.ts',
    'app/redux/actions/channels.ts',
    'app/redux/actions/emojis.ts',
    'app/redux/actions/errors.ts',
    'app/redux/actions/files.ts',
    'app/redux/actions/general.ts',
    'app/redux/actions/helpers.ts',
    'app/redux/actions/posts.ts',
    'app/redux/actions/preferences.ts',
    'app/redux/actions/roles.ts',
    'app/redux/actions/teams.ts',
    'app/redux/actions/timezone.ts',
    'app/redux/actions/users.ts',
    'app/redux/client/client4.ts',
    'app/redux/client/fetch_etag.ts',
    'app/redux/client/index.ts',
    'app/redux/constants/emoji.ts',
    'app/redux/constants/files.ts',
    'app/redux/constants/general.ts',
    'app/redux/constants/groups.ts',
    'app/redux/constants/index.ts',
    'app/redux/constants/permissions.ts',
    'app/redux/constants/plugins.ts',
    'app/redux/constants/posts.ts',
    'app/redux/constants/preferences.ts',
    'app/redux/constants/request_status.ts',
    'app/redux/constants/stats.ts',
    'app/redux/constants/teams.ts',
    'app/redux/constants/users.ts',
    'app/redux/constants/websocket.ts',
    'app/redux/reducers/entities/bots.ts',
    'app/redux/reducers/entities/channels.ts',
    'app/redux/reducers/entities/emojis.ts',
    'app/redux/reducers/entities/files.ts',
    'app/redux/reducers/entities/general.ts',
    'app/redux/reducers/entities/gifs.ts',
    'app/redux/reducers/entities/groups.ts',
    'app/redux/reducers/entities/index.ts',
    'app/redux/reducers/entities/integrations.ts',
    'app/redux/reducers/entities/jobs.ts',
    'app/redux/reducers/entities/posts.ts',
    'app/redux/reducers/entities/preferences.ts',
    'app/redux/reducers/entities/roles.ts',
    'app/redux/reducers/entities/schemes.ts',
    'app/redux/reducers/entities/search.ts',
    'app/redux/reducers/entities/teams.ts',
    'app/redux/reducers/entities/typing.ts',
    'app/redux/reducers/entities/users.ts',
    'app/redux/reducers/errors/index.ts',
    'app/redux/reducers/index.ts',
    'app/redux/reducers/requests/channels.ts',
    'app/redux/reducers/requests/files.ts',
    'app/redux/reducers/requests/general.ts',
    'app/redux/reducers/requests/helpers.ts',
    'app/redux/reducers/requests/index.ts',
    'app/redux/reducers/requests/jobs.ts',
    'app/redux/reducers/requests/posts.ts',
    'app/redux/reducers/requests/roles.ts',
    'app/redux/reducers/requests/search.ts',
    'app/redux/reducers/requests/teams.ts',
    'app/redux/reducers/requests/users.ts',
    'app/redux/reducers/websocket.ts',
    'app/redux/selectors/entities/channels.ts',
    'app/redux/selectors/entities/common.ts',
    'app/redux/selectors/entities/emojis.ts',
    'app/redux/selectors/entities/general.ts',
    'app/redux/selectors/entities/i18n.ts',
    'app/redux/selectors/entities/posts.ts',
    'app/redux/selectors/entities/preferences.ts',
    'app/redux/selectors/entities/roles.ts',
    'app/redux/selectors/entities/roles_helpers.ts',
    'app/redux/selectors/entities/teams.ts',
    'app/redux/selectors/entities/timezone.ts',
    'app/redux/selectors/entities/users.ts',
    'app/redux/store/configureStore.prod.ts',
    'app/redux/store/helpers.ts',
    'app/redux/store/index.ts',
    'app/redux/store/initial_state.ts',
    'app/redux/store/middleware.ts',
    'app/redux/store/reducer_registry.ts',
    'app/redux/types/actions.ts',
    'app/redux/utils/channel_utils.ts',
    'app/redux/utils/emoji_utils.ts',
    'app/redux/utils/event_emitter.ts',
    'app/redux/utils/file_utils.ts',
    'app/redux/utils/helpers.ts',
    'app/redux/utils/i18n_utils.ts',
    'app/redux/utils/key_mirror.ts',
    'app/redux/utils/post_utils.ts',
    'app/redux/utils/preference_utils.ts',
    'app/redux/utils/sentry.ts',
    'app/redux/utils/team_utils.ts',
    'app/redux/utils/user_utils.ts',
